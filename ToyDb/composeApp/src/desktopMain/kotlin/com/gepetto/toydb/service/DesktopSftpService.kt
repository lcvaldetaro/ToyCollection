...
class DesktopSftpService : SftpService {
    ...
    private fun connectClient(
        ...
        client.addHostKeyVerifier(object : HostKeyVerifier {
            override fun verify(hostname: String, port: Int, key: PublicKey): Boolean {
                ...
                GcLog.d("DesktopSftpService", "Host key unverified for $hostname. Prompting user...")
    ...
    private fun safeMkdirs(sftp: SFTPClient, path: String) {
        try {
            ...
            try {
                ...
                GcLog.e("DesktopSftpService", "Could not create directory $path: ${ex.message}")
            }
        }
    }
    ...
    override suspend fun testConnection(
        ...
        try {
            GcLog.d("DesktopSftpService", "Testing connection to ${config.host}:${config.port}...")
            ...
            GcLog.e("DesktopSftpService", "Connection test failed: ${e.message}", e)
            Result.failure(e)
        }
    }
    ...
    override suspend fun uploadData(
        ...
        try {
            ...
            GcLog.e("DesktopSftpService", "Upload failed: ${e.message}", e)
            Result.failure(e)
        }
    }
    ...
    override suspend fun downloadData(
        ...
        try {
            ...
            GcLog.e("DesktopSftpService", "Download failed: ${e.message}", e)
            Result.failure(e)
        }
    }
}
